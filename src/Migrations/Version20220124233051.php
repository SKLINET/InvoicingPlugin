...
final class Version20220124233051 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sylius_invoicing_plugin_line_item ADD tax_rate_code VARCHAR(255) DEFAULT NULL, ADD adjustment_promotion_total INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sylius_invoicing_plugin_line_item DROP tax_rate_code, DROP adjustment_promotion_total');
    }
}
